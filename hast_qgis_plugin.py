...
class HastQgisPlugin:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir, "i18n", "HastQgisPlugin_{}.qm".format(locale)
        )
        ...
        self.actions = []
        self.menu = self.tr("&HAST")
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar("HastQgisPlugin")
        self.toolbar.setObjectName("HastQgisPlugin")

        # print "** INITIALIZING HastQgisPlugin"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate("HastQgisPlugin", message)
    ...
    def initGui(self):
        ...
        icon_path = ":/plugins/hast_qgis_plugin/icon.png"
        self.add_action(
            icon_path,
            text=self.tr(""),
            callback=self.run,
    ...
    def unload(self):
        ...
        # print "** UNLOAD HastQgisPlugin"

        for action in self.actions:
            self.iface.removePluginMenu(self.tr("&HAST"), action)
